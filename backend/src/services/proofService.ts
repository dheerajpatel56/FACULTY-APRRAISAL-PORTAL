...
const PROOF_SOURCES: Source[] = [
  ...
  { key: 'cat2IndustryLinkages', section: '2.10 Industry Linkage', title: (r) => r.industryName, fields: [['proofFile', 'Proof']] },
  { key: 'cat2Startups', section: '2 Startups / Innovation', title: (r) => r.groupName, fields: [['proofFile', 'Proof']] },
